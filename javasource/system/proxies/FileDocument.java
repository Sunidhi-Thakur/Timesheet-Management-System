...
public class FileDocument
{
	...
	public static system.proxies.FileDocument initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		...
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.Project_Doc", mendixObject.getType()))
		...
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.Timsheet_Doc", mendixObject.getType()))
			return myfirstmodule.proxies.Timsheet_Doc.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.User_Doc", mendixObject.getType()))
